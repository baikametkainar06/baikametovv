...
let settings = {
    ...
    pages: [
        ...
        { 
            image: './image/photos/b13.jpg', // Menggantikan lhvuck.png (Index 1)
        },

        // --- Lembar 2 (data-page="1") ---
        { 
            image: './image/photos/b14.jpg', // Menggantikan fjr3qh.png (Index 2)
            content: 'Happy Birthday Sayang 💗' 
        },
        { 
            image: './image/photos/b12.jpg', // Menggantikan 8u5tf7.png (Index 3)
        },
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        matrixColor1: '#ff69b4', // Màu pink mẫu
        matrixColor2: '#ff1493', // Màu pink mẫu
        sequence: 'YOU|ARE|ALWAYS|BEAUTIFUL|❤',
        sequenceColor: '#ff69b4', // Màu pink mẫu
        gift: './image/happy3.gif',
        enableBook: true,
        enableHeart: true,
        ...
        pages: [
            ...
            { 
                image: './image/photos/b6.jpg', // Menggantikan lhvuck.png (Index 1)
            },

            // --- Lembar 2 (data-page="1") ---
            { 
                image: './image/photos/b3.jpg', // Menggantikan fjr3qh.png (Index 2)
                content: 'Your smile is everything' 
            },
            { 
                image: './image/photos/b9.jpg', // Menggantikan 8u5tf7.png (Index 3)
            },

            // --- Lembar 3 (data-page="2") ---
            { 
                image: './image/photos/b10.jpg', // Menggantikan tbutvj.png (Index 4)
                content: 'Balapan' 
            }
        ]
    };
...
// Function untuk apply settings yang sudah dimuat          
